/* ♥ OWT DRAW ~ Primitivas de desenho moe!
 * Dica: pixel a pixel, um quadrado por vez~
 * Se travar, é pq vc passou coordenada errada seu baka >_<
 * Font 8x16 linda, q nem vc~ kyun! <3 */
#ifndef OWT_DRAW_H
#define OWT_DRAW_H
#include <stdint.h>
