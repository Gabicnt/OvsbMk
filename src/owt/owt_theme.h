/* ♥ OWT THEME ~ Tema escuro e claro!
 * Dica: bg_primary = fundo, bg_secondary = superfície~
 * Tema escuro é o padrão pq é mais bonito >_<
 * Quem gosta de claro é psicopata, mas ta ai se quiser~ hihi
 * Atalhos THEME_BG etc pra n ficar chamando get toda hr ♥ */
#ifndef OWT_THEME_H
#define OWT_THEME_H
#include <stdint.h>
