/* ♥ OWT BUTTON ~ Botao clicavel com hover!
 * Dica: is_pressed muda a cor, is_hovered tb~
 * on_click é o callback, poe uma funcao legal
 * is_hovered vc chama com a pos do mouse, hihi ♥ */
#ifndef OWT_BUTTON_H
#define OWT_BUTTON_H
#include "owt_base.h"
