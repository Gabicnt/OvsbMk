/* ♥ OWT WINDOW ~ Desenha a janela na tela!
 * Dica: fundo primary, barra accent, texto branco~
 * Botao X vermelho 0xFFCC2222, lindo de morrer
 * Se content existir, desenha ele tb~ hihi ♥ */
