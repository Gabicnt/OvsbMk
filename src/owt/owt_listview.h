/* ♥ OWT LISTVIEW ~ Lista de itens selecionavel!
 * Dica: ate 32 itens de 64 chars cada~
 * scroll se tiver mt item, selected_index marca
 * on_select é chamado qdo clica num item~ hihi ♥ */
