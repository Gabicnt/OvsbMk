/* ♥ OWT BASE ~ Gerenciamento de widgets!
 * Dica: array estatico de 64 widgets, n precisa de malloc~
 * Se passar de 64, tenta de novo com menos, seu baka >_<
 * Hihi, children são ponteiros pro msm array~ ♥ */
#include "owt_base.h"
