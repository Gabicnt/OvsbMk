/* ♥ OWT COMBOBOX ~ Desenha dropdown bonito!
 * Dica: "v" indica q da pra abrir, setinha~
 * Fechado mostra só o item selecionado ou "Selecione..."
 * Aberto mostra a lista toda com scroll~ kyun ♥ */
