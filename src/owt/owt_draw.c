/* ♥ OWT DRAW ~ Desenha as parada na tela!
 * Dica: backbuffer do WM é nosso playground~
 * Se pixel não aparecer, WM n foi init, aff seu baka
 * Font 8x16 cabulosa, mt melhor q a do linux >_<
 * Agr com scl pra 1024+ resoluções, fica lindão ♥ */
#include "owt_draw.h"
#include "../wm/wm.h"
