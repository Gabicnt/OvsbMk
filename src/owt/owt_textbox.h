/* ♥ OWT TEXTBOX ~ Input de texto de 1 linha!
 * Dica: buffer de ate 256 chars, cursor piscando~
 * on_enter é chamado qdo aperta enter, util d+
 * set_text preenche, get_text pega o valor, hihi ♥ */
