/* ♥ OWT COMBOBOX ~ Dropdown de opcoes!
 * Dica: ate 16 itens, cada um com 64 chars~
 * is_open controla se a lista ta visivel ou n
 * click alterna open e seleciona item~ hihi ♥ */
