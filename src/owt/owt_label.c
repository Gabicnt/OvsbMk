/* ♥ OWT LABEL ~ Desenha texto na posição!
 * Dica: x, y é o canto superior esquerdo~
 * N tem fundo, ent coloca num container se quiser
 * Hihi, label não clica nem digita, so existe~ ♥ */
#include "owt_label.h"
#include "owt_draw.h"
#include "owt_theme.h"
