/* ♥ OWT THEME ~ Cores lindas pros widgets!
 * Dica: THEME_DARK é padrão, agradinha~
 * THEME_LIGHT é pra quem gosta de sofrer kkk
 * Se quiser add mais tema, so criar outra struct e setar ♥ */
#include "owt_theme.h"
