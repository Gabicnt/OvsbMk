/* ♥ OWT BUTTON ~ Desenha o botao lindao!
 * Dica: cor muda conforme estado (normal/hover/pressed)~
 * Borda fina do tema pra destacar~
 * Texto centralizado automaticamente, n precisa calcular ♥ */
